...
class _BotCommands:
    def __init__(self):
        ...
        self.StatusCommand = [f'status2{CMD_SUFFIX}', f's2{CMD_SUFFIX}', 'statusall2']
        ...
        self.PingCommand = [f'ping2{CMD_SUFFIX}', f'p2{CMD_SUFFIX}']
        self.RestartCommand = [f'restart2{CMD_SUFFIX}', f'r2{CMD_SUFFIX}', 'restartall2']
